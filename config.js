var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            hidden: false,
            title: 'Conclusion',
            description: 'The location selection of urban museums is often not only about the inheritance of history and culture, but also a reflection of the natural environment shaping the urban pattern. In Seoul, the geographical pattern of mountains surrounding and rivers flowing not only affects the direction of urban development, but also determines the spatial distribution of cultural facilities. Museums, historical sites, and natural landscapes are intertwined, and many cultural landmarks are built on mountains, waterfront areas, or important historical nodes, making urban cultural experiences closely integrated with the natural environment. This layout not only enhances the spatial narrative of the city, but also endows museums with richer environmental significance, making them a bridge connecting the past and present, nature and culture.',
            location: {
                center: [126.98367, 37.58002],
                zoom: 11.5,
                pitch: 0,
